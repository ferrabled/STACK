      ...
      {!isLoading && (
        <Card className="my-3">
          <div className="flex flex-col m-6">
            {typeNumber === 0 && (<SoftwareForm asset={data!} edit typeData={data} />)}
            {typeNumber === 1 && (<HardwareForm asset={data!} edit typeData={data} />)}
            {typeNumber === 2 && (<DocumentForm asset={data!} edit typeData={data} />)}
            {typeNumber === 3 && (<DataForm asset={data!} edit typeData={data} />)}
            {typeNumber === 4 && (<NetworkForm asset={data!} edit typeData={data} />)}
            {typeNumber === 5 && (<CloudForm asset={data!} edit typeData={data}/>)}
            {typeNumber === 6 && (<OtherForm asset={data!} edit typeData={data} />)}
